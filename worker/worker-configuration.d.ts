/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ecd3ee2f0b6908081bbf0842f23b2302)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		EMAIL_FROM: "OpenDesign <no-reply@opendesign.dqez.dev>";
		ORDER_CODE_PREFIX: "OD";
		LEGACY_ORDER_CODE_PREFIXES: "2D";
		PAID_EXTRACTION_AMOUNT: "25000";
		PAYMENT_CURRENCY: "VND";
		ORDER_TTL_HOURS: "24";
		PAYMENT_REQUIRED_MESSAGE: "Ban da su dung luot mien phi. Chuyen khoan 25.000d de tiep tuc.";
		...
		EXTRACTION_WORKFLOW: Workflow<Parameters<import("./src/index").ExtractionWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "SERVICE_NAME" | "DEV_ORIGIN" | "DEV_ORIGINS" | "FRONTEND_ORIGIN" | "R2_BUCKET_NAME" | "EXTRACTOR_URL" | "EMAIL_FROM" | "ORDER_CODE_PREFIX" | "LEGACY_ORDER_CODE_PREFIXES" | "PAID_EXTRACTION_AMOUNT" | "PAYMENT_CURRENCY" | "ORDER_TTL_HOURS" | "PAYMENT_REQUIRED_MESSAGE" | "SEPAY_QR_BASE_URL" | "SEPAY_ALLOWED_IPS" | "SEPAY_BANK_ACCOUNT" | "SEPAY_BANK_NAME" | "SEPAY_BANK_ACCOUNT_NAME">> {}
}
